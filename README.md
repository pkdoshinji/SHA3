...
The command-line tool presented here is an implementation of the SHA3-256 hash function. While it produces accurate results, it is not optimized for either performance or security. Rather, it is intended as a pedagogical tool.   
